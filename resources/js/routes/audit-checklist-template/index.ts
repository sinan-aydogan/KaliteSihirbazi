...
/**
* @see \App\Http\Controllers\AuditChecklistTemplateController::search
 ...
 */
export const print = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
print.url = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
print.get = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: print.url(args, options),
    method: 'get',
})
/**
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
print.head = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: print.url(args, options),
    method: 'head',
})
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
    const printForm = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
        printForm.get = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: print.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/audit-checklist-template/{auditChecklistTemplate}/print'
 */
        printForm.head = (args: { auditChecklistTemplate: number | { id: number } } | [auditChecklistTemplate: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
