 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:31
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:70
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:80
 * @route '/education'
 */
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:117
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:147
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:162
 * @route '/education/{education}'
 */
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:198
 * @route '/education/{education}'
 */
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:54
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:229
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:243
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:267
 ...
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:349
 * @route '/education/{education}/participants/{user}'
 */
...
/**
* @see \App\Http\Controllers\HumanResources\Education\EducationController::uploadParticipantDocument
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:311
 * @route '/education/{education}/participants/{user}/documents'
 */
export const uploadParticipantDocument = (args: { education: number | { id: number }, user: number | { id: number } } | [education: number | { id: number }, user: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: uploadParticipantDocument.url(args, options),
    method: 'post',
})

uploadParticipantDocument.definition = {
    methods: ["post"],
    url: '/education/{education}/participants/{user}/documents',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/education/{education}/participants/{user}/documents'
 */
uploadParticipantDocument.url = (args: { education: number | { id: number }, user: number | { id: number } } | [education: number | { id: number }, user: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    education: args[0],
                    user: args[1],
    ...
    return uploadParticipantDocument.definition.url
            .replace('{education}', parsedArgs.education.toString())
            .replace('{user}', parsedArgs.user.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/education/{education}/participants/{user}/documents'
 */
uploadParticipantDocument.post = (args: { education: number | { id: number }, user: number | { id: number } } | [education: number | { id: number }, user: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: uploadParticipantDocument.url(args, options),
    method: 'post',
})
 ...
 * @route '/education/{education}/participants/{user}/documents'
 */
    const uploadParticipantDocumentForm = (args: { education: number | { id: number }, user: number | { id: number } } | [education: number | { id: number }, user: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: uploadParticipantDocument.url(args, options),
        method: 'post',
    })
 ...
 * @route '/education/{education}/participants/{user}/documents'
 */
        uploadParticipantDocumentForm.post = (args: { education: number | { id: number }, user: number | { id: number } } | [education: number | { id: number }, user: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: uploadParticipantDocument.url(args, options),
            method: 'post',
        })
    
    uploadParticipantDocument.form = uploadParticipantDocumentForm
/**
* @see \App\Http\Controllers\HumanResources\Education\EducationController::deleteParticipantDocument
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:331
 * @route '/education/{education}/participants/{user}/documents/{mediaId}'
 */
export const deleteParticipantDocument = (args: { education: number | { id: number }, user: number | { id: number }, mediaId: string | number } | [education: number | { id: number }, user: number | { id: number }, mediaId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: deleteParticipantDocument.url(args, options),
    method: 'delete',
})

deleteParticipantDocument.definition = {
    methods: ["delete"],
    url: '/education/{education}/participants/{user}/documents/{mediaId}',
} satisfies RouteDefinition<["delete"]>
 ...
 * @route '/education/{education}/participants/{user}/documents/{mediaId}'
 */
deleteParticipantDocument.url = (args: { education: number | { id: number }, user: number | { id: number }, mediaId: string | number } | [education: number | { id: number }, user: number | { id: number }, mediaId: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    education: args[0],
                    user: args[1],
    ...
    return deleteParticipantDocument.definition.url
            .replace('{education}', parsedArgs.education.toString())
            .replace('{user}', parsedArgs.user.toString())
 ...
 * @route '/education/{education}/participants/{user}/documents/{mediaId}'
 */
deleteParticipantDocument.delete = (args: { education: number | { id: number }, user: number | { id: number }, mediaId: string | number } | [education: number | { id: number }, user: number | { id: number }, mediaId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: deleteParticipantDocument.url(args, options),
    method: 'delete',
})
 ...
 * @route '/education/{education}/participants/{user}/documents/{mediaId}'
 */
    const deleteParticipantDocumentForm = (args: { education: number | { id: number }, user: number | { id: number }, mediaId: string | number } | [education: number | { id: number }, user: number | { id: number }, mediaId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: deleteParticipantDocument.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'DELETE',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/education/{education}/participants/{user}/documents/{mediaId}'
 */
        deleteParticipantDocumentForm.delete = (args: { education: number | { id: number }, user: number | { id: number }, mediaId: string | number } | [education: number | { id: number }, user: number | { id: number }, mediaId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: deleteParticipantDocument.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    deleteParticipantDocument.form = deleteParticipantDocumentForm
/**
* @see \App\Http\Controllers\HumanResources\Education\EducationController::deleteMedia
 * @see app/Http/Controllers/HumanResources/Education/EducationController.php:365
...
addParticipant: Object.assign(addParticipant, addParticipant),
updateParticipant: Object.assign(updateParticipant, updateParticipant),
removeParticipant: Object.assign(removeParticipant, removeParticipant),
uploadParticipantDocument: Object.assign(uploadParticipantDocument, uploadParticipantDocument),
deleteParticipantDocument: Object.assign(deleteParticipantDocument, deleteParticipantDocument),
