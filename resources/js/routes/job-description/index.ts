...
*/
export const permanentDelete = (args: { jobDescription: string | number | { id: string | number } } | [jobDescription: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/job-description-permanent-delete/{jobDescription}'
*/
permanentDelete.url = (args: { jobDescription: string | number | { id: string | number } } | [jobDescription: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
...
* @route '/job-description-permanent-delete/{jobDescription}'
*/
permanentDelete.delete = (args: { jobDescription: string | number | { id: string | number } } | [jobDescription: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: permanentDelete.url(args, options),
    method: 'delete',
})
...
* @route '/job-description-permanent-delete/{jobDescription}'
*/
const permanentDeleteForm = (args: { jobDescription: string | number | { id: string | number } } | [jobDescription: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/job-description-permanent-delete/{jobDescription}'
*/
permanentDeleteForm.delete = (args: { jobDescription: string | number | { id: string | number } } | [jobDescription: string | number | { id: string | number } ] | string | number | { id: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: permanentDelete.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
