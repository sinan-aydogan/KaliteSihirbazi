            ...
            <div v-show="modelValue" class="fixed flex inset-0 overflow-y-auto sm:px-0 z-50" :class="[
                ...
                <transition enter-active-class="ease-out duration-300"
                    ...
                    <div id="draggable" v-if="modelValue"
                        ...
                        <!--Header-->
                        <div class="flex space-y-1 border-b items-center px-4 py-2 bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 first:rounded-t-lg select-none"
...
updateSize();
                        ...
                        <!--Body-->
                        <div class="flex p-4 first:rounded-t-lg last:rounded-b-lg bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200"
                            :class="[
                                {
