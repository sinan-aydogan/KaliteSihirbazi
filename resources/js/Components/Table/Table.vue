        ...
        <div
            ...
            <table class="w-full mt-4 text-sm">
                ...
                <tr>
                    ...
                    <th>
                        <div class="flex flex-shrink-0 justify-center items-center  text-slate-400 font-semibold"
                ...
                <!--Body-->
                <tbody :style="`filter: drop-shadow(0 0 1px rgba('${(gData['length']>0 ? '0,0,0,0.25' : '14,165,233,1')}}'))`">
                <template v-for="row in gData">
                    <tr class="group">
                        ...
                        <!--Actions-->
                        <td class="border-b group-last:border-b-0"
                            v-if="editAction || deleteAction || showAction || restoreAction || $slots.hasOwnProperty('leftItemAction') || $slots.hasOwnProperty('rightItemAction')"
                            :class="[
                        selectedItems.includes(row[uniqueIdKey]) ? 'bg-rose-50 border-rose-300 group-hover:bg-rose-100' : 'bg-slate-100 dark:bg-slate-500 group-odd:bg-slate-50 dark:group-odd:bg-slate-600 group-hover:bg-slate-200 dark:group-hover:bg-slate-700 border-slate-300'
                        ]">
                            <div
                                ...
                                <!--Left of the Item Actions-->
                                <slot name="leftItemAction" :props="row"/>
                                ...
                                <!--Right of the Item Actions-->
                                <slot name="rightItemAction" :props="row"/>
                            </div>
                        </td>
                    </tr>
                </template>
