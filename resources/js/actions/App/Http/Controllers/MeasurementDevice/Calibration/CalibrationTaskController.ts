 ...
 * @see app/Http/Controllers/MeasurementDevice/Calibration/CalibrationTaskController.php:13
...
const CalibrationTaskController = { index }

export default CalibrationTaskController