...
*/
export const permanentDestroy = (args: { measurementDeviceType: number | { id: number } } | [measurementDeviceType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
...
* @route '/measurement-device-type-permanent-delete/{measurementDeviceType}'
*/
permanentDestroy.url = (args: { measurementDeviceType: number | { id: number } } | [measurementDeviceType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
...
* @route '/measurement-device-type-permanent-delete/{measurementDeviceType}'
*/
permanentDestroy.delete = (args: { measurementDeviceType: number | { id: number } } | [measurementDeviceType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: permanentDestroy.url(args, options),
    method: 'delete',
})
...
* @route '/measurement-device-type-permanent-delete/{measurementDeviceType}'
*/
const permanentDestroyForm = (args: { measurementDeviceType: number | { id: number } } | [measurementDeviceType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/measurement-device-type-permanent-delete/{measurementDeviceType}'
*/
permanentDestroyForm.delete = (args: { measurementDeviceType: number | { id: number } } | [measurementDeviceType: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: permanentDestroy.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'DELETE',
            ...(options?.query ?? options?.mergeQuery ?? {}),
