 ...
 * @see app/Http/Controllers/Document/DocumentController.php:75
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:112
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:135
 * @route '/document'
 */
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:177
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:231
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:243
 * @route '/document/{document}'
 */
 ...
 * @see app/Http/Controllers/Document/DocumentController.php:254
 * @route '/document/{document}'
 */
...
/**
* @see \App\Http\Controllers\Document\DocumentController::cancel
 * @see app/Http/Controllers/Document/DocumentController.php:268
 * @route '/document/{document}/cancel'
 */
export const cancel = (args: { document: number | { id: number } } | [document: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/document/{document}/cancel'
 */
cancel.url = (args: { document: number | { id: number } } | [document: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { document: args }
    }
 ...
 * @route '/document/{document}/cancel'
 */
cancel.post = (args: { document: number | { id: number } } | [document: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: cancel.url(args, options),
    method: 'post',
})
 ...
 * @route '/document/{document}/cancel'
 */
    const cancelForm = (args: { document: number | { id: number } } | [document: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/document/{document}/cancel'
 */
        cancelForm.post = (args: { document: number | { id: number } } | [document: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: cancel.url(args, options),
            method: 'post',
        })
    
    cancel.form = cancelForm
const DocumentController = { index, create, store, show, edit, update, destroy, cancel }
