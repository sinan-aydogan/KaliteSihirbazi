...
/**
* @see \App\Http\Controllers\HumanResources\Employee\DebtController::index
 * @see app/Http/Controllers/HumanResources/Employee/DebtController.php:12
 * @route '/employee/{employee}/debt'
 */
