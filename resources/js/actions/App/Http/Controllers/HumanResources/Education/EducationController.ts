...
const EducationController = { index, create, store, show, edit, update, destroy, deleted, permanentDestroy, restore, addParticipant, updateParticipant, removeParticipant, uploadParticipantDocument, deleteParticipantDocument, deleteMedia }
