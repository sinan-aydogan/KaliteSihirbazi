...
const handleDelete = () => {
    router.delete(route('device.destroy', props.data.id))
}
</script>
...
<template>
    <app-layout :title="data.name">
        <template #actionArea>
            ...
            <simple-button type="route" :link="route('device.index')">
        ...
        <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 md:col-span-6">
                <EquipmentAreaAssignment equipment-type="device" :equipment-id="data.id" :areas="data.areas" :all-areas="allAreas"/>
            </div>
            <div class="col-span-12 md:col-span-6">
                <EquipmentOperatorAuthorizations equipment-type="device" :equipment-id="data.id" :authorizations="data.operator_authorizations" :employees="employees"/>
            </div>
        </div>
    </app-layout>
</template>
