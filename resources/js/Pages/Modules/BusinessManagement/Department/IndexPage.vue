...
// Rules
const departmentValidation = (value) =>
    (form.type === "main" && !value) || (form.type === "sub" && value);
const rules = ref({
    code: {
        ...
        maxLength: helpers.withMessage(
            t("message.validation.maxLength", [10]),
            maxLength(10),
        ),
    },
    name: {
        ...
        maxLength: helpers.withMessage(
            t("message.validation.maxLength", [255]),
            maxLength(255),
        ),
    },
    type: {
    ...
    department_id: {
        departmentValidation: helpers.withMessage(
            t("message.validation.required"),
        ...
        >
            <template #manager="{ props }">
                <div class="flex space-x-2 items-center">
                    <avatar
                        :src="
                            props.manager.has_account
                                ? props.manager.account.profile_photo_url
                                : ''
                        "
                    />
